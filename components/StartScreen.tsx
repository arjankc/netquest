...
export const StartScreen: React.FC<Props> = ({ onStartGame }) => {
  ...
  return (
    <div className="h-full w-full bg-game-dark overflow-y-auto">
      <div className="flex flex-col items-center justify-center min-h-full p-4 md:p-8">
        <motion.div
          initial={{ scale: 0.8, opacity: 0 }}
          animate={{ scale: 1, opacity: 1 }}
          className="mb-8 md:mb-12 mt-4 md:mt-0 text-center"
        >
          <div className="flex items-center justify-center mb-4">
            <Monitor className="w-12 h-12 md:w-16 md:h-16 text-game-accent mr-3" />
        ...
        <div className="w-full max-w-[95%] md:max-w-[700px] lg:max-w-3xl bg-game-surface p-6 md:p-10 rounded-2xl shadow-2xl border-2 border-white/10 mb-8">
          ...
          {/* Counter Control */}
          <div className="flex items-center justify-center gap-6 md:gap-10 mb-8 md:mb-10">
            <button 
              onClick={decrement}
            ...
            <div className="text-7xl md:text-9xl font-display font-bold text-white w-24 md:w-40 text-center drop-shadow-lg">
              {teamCount}
            </div>
